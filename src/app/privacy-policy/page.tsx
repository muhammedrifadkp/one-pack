    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="bg-white p-8 sm:p-12 rounded-3xl border border-gray-100 shadow-xl space-y-6">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-gray-600 leading-relaxed">
          ...
          <p>
            For any privacy inquiries or data update requests, please contact us via email at <strong>onepackonline@gmail.com</strong>, phone at <strong>+91 99952 16808</strong>, or WhatsApp at <strong>+91 90199 66790</strong>. Address: 3rd floor, Brothers Traders, Railway Station road, Kanhangad, 671315.
          </p>
        </div>
      </div>
    </div>
